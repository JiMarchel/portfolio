<script lang="ts">
  ...
  // Simple read time estimation (approx 200 words per minute)
...
<div class="min-h-screen pb-20">
  ...
  {:else}
    <!-- Wrapper Grid untuk seluruh article + TOC -->
    <div
      class="max-w-7xl mx-auto px-6 grid grid-cols-1 xl:grid-cols-[1fr_280px] gap-10"
    >
      <!-- Article Content -->
      <article>
        <!-- Header Section -->
      ...
      <!-- Table of Contents - Sidebar Kanan (Sticky dari atas) -->
